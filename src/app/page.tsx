        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start" id="download">
              <a
                href="https://apps.apple.com/ca/app/film-budget-planner/id6761828159"
                target="_blank"
              ...
              >
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-xs font-normal opacity-70">Download on the</span>
                  <span className="text-base">App Store</span>
                </span>
              </a>
              <div className="flex items-center gap-2 text-sm text-text-muted">
                <span className="hidden sm:inline">Android coming soon</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-bg-card rounded-3xl p-12 md:p-16 border border-white/5 glow-lime relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-text-muted text-sm">Android coming soon</p>
            </div>
          </div>
        </div>
      </div>
